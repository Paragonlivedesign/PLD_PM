 ...
 */
export function resolveTenantUserIds(req) {
    const payload = decodeBearerPayload(req);
    const tenantFromJwt = typeof payload?.tenant_id === "string"
    ...
    const tenantId = tenantFromJwt || tenantHeader || (allowDefault ? DEFAULT_TENANT : "");
