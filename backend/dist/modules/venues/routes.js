...
import { bannerPreviewQuerySchema, createVenueSchema, listVenuesQuerySchema, resolveMapsLinkSchema, updateVenueSchema, } from "./schemas.js";
...
venuesRouter.post("/resolve-maps-link", requirePermission("venues:update"), asyncHandler(async (req, res) => {
    try {
...
venuesRouter.get("/:id/banner-preview", requirePermission("venues:read"), asyncHandler(async (req, res) => {
    try {
