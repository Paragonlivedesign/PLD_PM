...
export const TEMPLATE_VARIABLE_CATALOG = [
    ...
    },
    {
        ...
        kind: "html",
        description: "HTML table of tenant personnel (name, role, email). Not filtered to event crew assignments yet.",
    },
    {
...
export const BUILTIN_MERGE_KEYS = TEMPLATE_VARIABLE_CATALOG.map((e) => e.key);
