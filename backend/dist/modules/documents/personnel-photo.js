...
export async function validatePersonnelPhotoDocument(pool, tenantId, documentId, personnelId) {
...
export function buildDocumentFilePublicUrl(documentId, tenantId, req) {
