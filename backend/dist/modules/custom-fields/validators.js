...
export function validateValueForDefinition(def, value, opts = {}) {
    ...
    switch (ft) {
        case "text": {
            ...
            if (rules?.pattern) {
                try {
                    ...
                    if (!re.test(value))
                        return { ok: false, code: "INVALID_FORMAT", message: "Does not match pattern" };
                }
                catch {
        ...
        case "boolean": {
            if (typeof value !== "boolean")
                return { ok: false, code: "INVALID_TYPE", message: "Must be boolean" };
            return { ok: true, value };
        }
        case "date": {
            if (typeof value !== "string")
            ...
            if (!parsed)
                return { ok: false, code: "INVALID_FORMAT", message: "Expected YYYY-MM-DD" };
            if (rules?.min_date) {
            ...
            if (rules?.not_in_past) {
                const t = todayUtc();
                if (cmpDate(parsed, t) < 0)
                    return { ok: false, code: "OUT_OF_RANGE", message: "Date cannot be in the past" };
            }
            return { ok: true, value };
        }
        case "datetime": {
            ...
            if (Number.isNaN(ms))
                return { ok: false, code: "INVALID_FORMAT", message: "Invalid datetime" };
            ...
            if (rules?.not_in_past) {
                if (dt.getTime() < Date.now())
                    return { ok: false, code: "OUT_OF_RANGE", message: "Datetime cannot be in the past" };
            }
        ...
        case "select": {
            ...
            if (!opt)
                return { ok: false, code: "INVALID_OPTION", message: "Unknown option" };
        ...
        case "multi_select": {
            if (!Array.isArray(value))
                return { ok: false, code: "INVALID_TYPE", message: "Must be array of strings" };
            const set = new Set();
            for (const v of value) {
                ...
                if (!opt)
                    return { ok: false, code: "INVALID_OPTION", message: `Unknown option ${v}` };
                if (opt.is_deprecated && !opts.allowDeprecatedSelect)
                    return { ok: false, code: "INVALID_OPTION", message: `Option ${v} is deprecated` };
                if (set.has(v))
                    return { ok: false, code: "INVALID_FORMAT", message: "Duplicate option" };
                set.add(v);
            }
            return { ok: true, value };
        }
        case "url": {
            if (typeof value !== "string")
                return { ok: false, code: "INVALID_TYPE", message: "Must be string" };
            try {
        ...
        case "email": {
            ...
            if (!EMAIL_RE.test(value))
                return { ok: false, code: "INVALID_FORMAT", message: "Invalid email" };
            return { ok: true, value };
        }
        case "phone": {
            if (typeof value !== "string")
...
export function validateDefaultValueForCreate(fieldType, defaultValue, validationRules, options) {
    const fake = {
        id: "",
        entity_type: "event",
        field_key: "_",
