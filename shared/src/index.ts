...
export type SchedulingConflictKind =
  | "double_booking"
  | "drive_time_infeasible"
  | "truck_double_booking";
...
export type RouteLocationRef =
  ...
  | { kind: "coordinates"; latitude: number; longitude: number; label?: string | null }
  | { kind: "venue"; venue_id: string }
  | {
      kind: "contact";
      contact_id: string;
      use?: "primary" | "custom";
