...
function renderDashboardPM() {
  const activeEvents = EVENTS.filter(e => !['settled', 'archived'].includes(e.phase)).length;
  ...
  return `
    <div class="stats-row">
      ...
      <div class="stat-card">
        ...
        <div class="stat-change">${liveEvents > 0 ? 'UFC 310 - Championship Night' : 'No live events'}</div>
      </div>
      <div class="stat-card">
      ...
      <div class="card">
        ...
        <div class="table-wrap">
          <table class="data-table">
            ...
            <tbody>
              ${EVENTS.filter(e => !['settled', 'archived'].includes(e.phase)).sort((a,b) => a.startDate.localeCompare(b.startDate)).slice(0, 6).map(ev => `
...
function renderDashboardDept() {
  ...
  const deptEvents = EVENTS.filter(e => !['settled', 'archived'].includes(e.phase) && e.crew.some(c => deptCrew.some(d => d.id === c)));
...
function renderDashboardCrew() {
  ...
  const myEvents = EVENTS.filter(e => e.crew.includes(myId) && !['settled', 'archived'].includes(e.phase)).sort((a,b) => a.startDate.localeCompare(b.startDate));
      ...
      <div class="card">
        ...
        <div class="table-wrap">
          <table class="data-table">
            ...
            <tbody>
              <tr><td style="font-weight:500;">INV-2026-001</td><td>NBA</td><td><span class="phase-badge" style="font-size:10px;background:var(--accent-green);color:#fff;">Paid</span></td><td>Feb 1</td></tr>
              <tr><td style="font-weight:500;">INV-2026-002</td><td>UFC</td><td><span class="phase-badge" style="font-size:10px;background:var(--accent-amber);color:#fff;">Sent</span></td><td>Feb 28</td></tr>
              <tr><td style="font-weight:500;">INV-2026-003</td><td>NFL</td><td><span class="phase-badge" style="font-size:10px;background:var(--accent-red);color:#fff;">Overdue</span></td><td>Jan 15</td></tr>
            </tbody>
          </table>
        </div>
      </div>
